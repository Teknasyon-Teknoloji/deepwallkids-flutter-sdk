...
class DeepWallKidsException implements Exception {
  int? code;
  String? message;

  DeepWallKidsException(ErrorCode code) {
    this.code = code.value!['code'];
    this.message = code.value!['message'];
  }
}

extension DeepWallKidsError on ErrorCode {
  static const values = {
    ErrorCode.NATIVE_MODULE_NOT_FOUND: {
      "code": 101,
      "message": 'Native module "DeepWallKids" not found.',
    },
    ErrorCode.NATIVE_MODULE_EVENT_EMITTER_NOT_FOUND: {
      "code": 121,
      "message": 'Native module "DeepWallKidsEmitter" not found.',
    },
