package com.deepwallkids.deepwallkids_flutter_plugin
...
/** DeepWallKidsFlutterPlugin */
class DeepWallKidsFlutterPlugin(): FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  val eventStremHandler = DeepWallKidsStreamHandler()

  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    //val instance = DeepWallKidsFlutterPlugin()
    val channel = MethodChannel(flutterPluginBinding.binaryMessenger, "deepwallkids_flutter_plugin")
    channel.setMethodCallHandler(this)
    val eventChannel = EventChannel(flutterPluginBinding.binaryMessenger,"deepwallkids_plugin_stream")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val instance = DeepWallKidsFlutterPlugin()
      val channel = MethodChannel(registrar.messenger(), "deepwallkids_flutter_plugin")
      channel.setMethodCallHandler(instance)
      val eventChannel = EventChannel(registrar.messenger(),"deepwallkids_plugin_stream")
      eventChannel.setStreamHandler(instance.eventStremHandler)
      instance.context = registrar.context()
    }
  }

  class DeepWallKidsStreamHandler : EventChannel.StreamHandler {
    ...
    EventBus.subscribe(Consumer {
      ...
      when (it.type) {
        DeepWallEvent.PAYWALL_OPENED.value -> {
          ...
          map.put("event", "deepWallKidsPaywallOpened")
        ...
        DeepWallEvent.DO_NOT_SHOW.value -> {
          ...
          val modelMap = convertJsonToMap(convertJson(data))
          map.put("data", modelMap)
          map.put("event", "deepWallKidsPaywallActionShowDisabled")
          eventStremHandler.sendData(map)
        }
        DeepWallEvent.CLOSED.value -> {
          ...
          val modelMap = convertJsonToMap(convertJson(data))
          map.put("data", modelMap)
          map.put("event", "deepWallKidsPaywallClosed")
          eventStremHandler.sendData(map)
        }
        DeepWallEvent.PAYWALL_PURCHASING_PRODUCT.value -> {
          ...
          val modelMap = convertJsonToMap(convertJson(data))
          map.put("data", modelMap)
          map.put("event", "deepWallKidsPaywallPurchasingProduct")
          eventStremHandler.sendData(map)
        }
        DeepWallEvent.PAYWALL_PURCHASE_FAILED.value -> {
          ...
          val modelMap = convertJsonToMap(convertJson(data))
          map.put("data", modelMap)
          map.put("event", "deepWallKidsPaywallPurchaseFailed")
          eventStremHandler.sendData(map)
        }
        DeepWallEvent.PAYWALL_PURCHASE_SUCCESS.value -> {
          ...
          val modelMap = convertJsonToMap(convertJson(data))
          map.put("data", modelMap)
          map.put("event", "deepWallKidsPaywallPurchaseSuccess")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.PAYWALL_RESPONSE_FAILURE.value -> {
          ...
          map.put("event", "deepWallKidsPaywallResponseFailure")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.PAYWALL_RESTORE_SUCCESS.value -> {
          ...
          map.put("event", "deepWallKidsPaywallRestoreSuccess")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.PAYWALL_RESTORE_FAILED.value -> {
          map = HashMap<String,Any>()
          map.put("data", it.data.toString())
          map.put("event", "deepWallKidsPaywallRestoreFailed")
          eventStremHandler.sendData(map)
        }
        DeepWallEvent.EXTRA_DATA.value -> {
          ...
          map.put("event", "deepWallKidsPaywallExtraDataReceived")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.PAYWALL_REQUESTED.value -> {
          map = HashMap<String,Any>()
          map.put("data", "")
          map.put("event", "deepWallKidsPaywallRequested")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.PAYWALL_RESPONSE_RECEIVED.value -> {
          map = HashMap<String,Any>()
          map.put("data", "")
          map.put("event", "deepWallKidsPaywallResponseReceived")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.CONSUME_SUCCESS.value -> {
          map = HashMap<String,Any>()
          map.put("data", "")
          map.put("event", "deepWallKidsPaywallConsumeSuccess")
          eventStremHandler.sendData(map)
        }
        ...
        DeepWallEvent.CONSUME_FAILURE.value -> {
          map = HashMap<String,Any>()
          map.put("data", "")
          map.put("event", "deepWallKidsPaywallConsumeFailure")
          eventStremHandler.sendData(map)
        }
      }
    })
